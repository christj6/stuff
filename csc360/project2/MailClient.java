...
public class MailClient extends Frame
{
    ...
    * the relevant information (From, To, Subject, and message). */
    public MailClient()
    {
        ...
        serverPanel.add(serverField, BorderLayout.CENTER); fromPanel.add(fromLabel, BorderLayout.WEST);
        ...
        fieldPanel.add(toPanel); fieldPanel.add(subjectPanel);
        
        /* Create a panel for the buttons and add listeners to the buttons. */
        Panel buttonPanel = new Panel(new GridLayout(1, 0)); btSend.addActionListener(new SendListener());
